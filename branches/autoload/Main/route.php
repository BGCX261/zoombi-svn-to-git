...
class Zoombi_Route
{
	...
	/**
	 * Constructor
	 * @param string|Zoombi_Route $a_params
	 */
	public function __construct( $a_url = null )
	{
		$this->m_segments = array();
		$this->m_query = new Zoombi_Registry;
	...
	{
		return isset($this->m_segments[0]) ? $this->m_segments[0] : null;
	}
	...
	{
		return isset($this->m_segments[1]) ? $this->m_segments[1] : null;
	}
	...
	{
		return isset($this->m_segments[2]) ? $this->m_segments[2] : null;
	}
	...
	public function __isset( $a_name )
	{
		...
		return $this->m_query->hasValue($a_name);
	}
