 ...
 * Data base model
 *
 * @method Zoombi_SqlBuilder|Zoombi_Model_Database select
 * @method Zoombi_SqlBuilder|Zoombi_Model_Database update
 * @method Zoombi_SqlBuilder|Zoombi_Model_Database delete
 * @method Zoombi_SqlBuilder|Zoombi_Model_Database insert
 * @method Zoombi_SqlBuilder|Zoombi_Model_Database where
 * @method Zoombi_SqlBuilder|Zoombi_Model_Database order
 * @method Zoombi_SqlBuilder|Zoombi_Model_Database into
 * @method Zoombi_SqlBuilder|Zoombi_Model_Database having
 * @method Zoombi_SqlBuilder|Zoombi_Model_Database offset
 * @method Zoombi_SqlBuilder|Zoombi_Model_Database group
 * @method Zoombi_SqlBuilder|Zoombi_Model_Database groupby
 * @method string compile
 * @method Zoombi_SqlBuilder|Zoombi_Model_Database set
 * @uses Zoombi_SqlBuilder
 */
class Zoombi_Model_Database extends Zoombi_Model
{
	...
	{
		$o = $this->result(Zoombi_Database::RESULT_TYPE_NUM, 1);
