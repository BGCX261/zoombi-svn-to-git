...
class Zoombi_RoutePath
{

	/**
	 * @var Zoombi_RoutePath $parent;
	 */
	public $parents;

	/**
	 * @var Zoombi_Controller $controller
	 */
	public $controller;
	...
	public function isValid()
	{
		...
		{
			if($p AND $p instanceof Zoombi_Module)
				continue;
			else
				return false;
		}

		return $this->controller instanceof Zoombi_Controller AND !empty($this->action);
	}
