 ...
 * Http responce class
 */
class Zoombi_Response implements Zoombi_Singleton
{
	...
	/**
	 * Get Zoombi_Response singleton instance
	 * @var Zoombi_Response
	 */
	...
	public function & addHeader( $a_header )
	{
		...
		{
			case 1:
				$h = new Zoombi_Header(func_get_arg(0));
				break;

			case 2:
				$h = new Zoombi_Header(func_get_args());
				break;
		}
	...
	public function setDocument( Zoombi_Document & $a_document )
	{
	...
	{
		Zoombi_Headers::setCode($this->m_code, $this->m_message);
