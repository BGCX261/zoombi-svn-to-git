...
abstract class Zoombi_Plugin_Auth extends Zoombi_Plugin_Application
{
	...
	private function _request_auth()
	{
		...
		throw new Zoombi_Exception_Controller('Unauthorized', Zoombi_Exception_Controller::EXC_AUTH);
	}
	...
	{
		return $this->_do_auth($this->getModule()->getConfig()->get('auth',self::AUTH_BASIC));
	}
