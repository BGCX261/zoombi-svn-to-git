	...
	public function & open( $a_url )
	{
		...
		if( $this->m_sheme )
		{
			...
			if( !$adapter || !($adapter instanceof ZDatabaseAdapter) )
				throw new ZDatabaseException('Bad ZDatabaseAdapter sheme given: ' . $this->m_sheme, ZDatabaseException::EXC_OPEN);
		...
		{
			throw new ZDatabaseException('Bad scheme given ' . $this->m_sheme, ZDatabaseException::EXC_OPEN);
		}
